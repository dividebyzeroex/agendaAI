...
SELECT cron.schedule('whatsapp-reminders', '*/30 * * * *', 'SELECT net.http_post(url:=''https://xxx.supabase.co/functions/v1/cron-whatsapp-reminders'', headers:=''{"Authorization": "Bearer YOUR_ANON_KEY"}'');');
